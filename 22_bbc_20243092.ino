...
#define _INTERVAL_SERIAL  10 // serial interval (unit: ms)
...
#define _DUTY_NEU 1850 // 1500
#define _DUTY_MIN 1200 // 1000

#define _SERVO_ANGLE_DIFF  55  // Replace with |D - E| degree
#define _SERVO_SPEED       1000  // servo speed

#define _BANGBANG_RANGE    1500  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return 489 + (-1.59*a_value) + 1.3*pow(10,-3)*pow(a_value,2) ;
}
